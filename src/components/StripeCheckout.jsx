...
const promise = loadStripe(
  "pk_test_51O6vRaSHDMjjmfkZQk5Bxelaefj9PItsrocrYUWikdNqxZD7lhaPc1JfXw6CaZtHxUhMfK5I3i4p8FRi2mq5lBHx008yaqVbT0",
);
  ...
  const createPaymentIntent = async () => {
    try {
     ...
     setClientSecret(data.clientSecret)
      ...
      console.warn("Create payment intent error", error);
    }
  };
